...
const coApplicantUploadFields = Array.from({ length: 10 }).flatMap((_, index) => [
  { name: `coApplicant_${index}_aadhaarFile`, maxCount: 1 },
  { name: `coApplicant_${index}_panFile`, maxCount: 1 },
  { name: `coApplicant_${index}_bankStatementFile`, maxCount: 1 },
  ...Array.from({ length: 20 }).map((__, documentIndex) => ({
    name: `coApplicant_${index}_extra_${documentIndex}_files`,
    maxCount: 10,
  })),
]);
...
const loanUploadFields = [
  ...
  { name: "inspectionPhotosUrl", maxCount: 10 },
  { name: "landDocumentsUrl", maxCount: 10 },
  { name: "pan_card", maxCount: 1 },
  { name: "aadhaar_card", maxCount: 1 },
  { name: "photo", maxCount: 1 },
  { name: "itr_form_16", maxCount: 1 },
  { name: "form_16ab", maxCount: 1 },
  ...
  { name: "catalogDocuments", maxCount: 50 },
...
router.post(
  "/agency",
  dynamicUpload(loanUploadFields),
