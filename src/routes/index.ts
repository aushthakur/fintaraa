...
import pushCampaignRoutes from "../admin/pushCampaign/pushCampaign.routes";
import applicationDocumentReviewRoutes from "../admin/applicationDocumentReview/applicationDocumentReview.routes";
import engagementRoutes from "../public/engagement/engagement.routes";
import dripCampaignRoutes from "../admin/dripCampaign/dripCampaign.routes";
import popupCampaignRoutes from "../admin/popupCampaign/popupCampaign.routes";
import grievanceRoutes from "../admin/grievance/grievance.routes";
import bulkCommunicationRoutes from "../admin/bulkCommunication/bulkCommunication.routes";
import publicPartnerRoutes from "../public/partner/partner.routes";
import adminPartnerRoutes from "../admin/partner/partner.routes";
import dsaRoutes from "../public/dsa/dsa.routes";
import adminDsaRoutes from "../admin/dsa/dsa.routes";
import reportingRoutes from "../admin/reporting/reporting.routes";
...
router.use("/push-campaigns", pushCampaignRoutes);
router.use("/application-document-reviews", applicationDocumentReviewRoutes);
router.use("/engagement", engagementRoutes);
router.use("/drip-campaigns", dripCampaignRoutes);
router.use("/popups", popupCampaignRoutes);
router.use("/grievances", grievanceRoutes);
router.use("/bulk-communications", bulkCommunicationRoutes);
router.use("/partners", publicPartnerRoutes);
